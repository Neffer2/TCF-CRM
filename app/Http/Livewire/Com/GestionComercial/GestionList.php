...
{ 
    ...
    {   
        $this->getData();
        $datos = GestionComercial::select('id','id_contacto','id_estado', 'nom_proyecto_cot')->where('id_user', Auth::id())->orWhere('comercial_2', Auth::id())->orWhere('comercial_3', Auth::id())->orWhere('comercial_4', Auth::id())->orderBy('id', 'asc')->paginate(5);
