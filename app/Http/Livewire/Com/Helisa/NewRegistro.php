...
class NewRegistro extends Component
{
    ...
    // Datos principales del formulario Helisa
    public $fecha = "";
    public $tipo_doc = "";
    public $num_doc = "";
    ...
    // Renderiza la vista del formulario de nuevo registro
    ...
    public function mount(){
        ...
        // Por defecto, el comercial principal es el usuario autenticado
    ...
    // Guarda el nuevo registro Helisa en la base de datos
    public function store(){
        ...
        // Crea un registro Helisa por cada participación
        $i  = 0;
        while($i < $this->participaciones){
            $helisa = new Helisa;
