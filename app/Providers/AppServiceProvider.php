...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        config([
            ...
            'servicios' => [
                'TRANSPORTE',
                'TRANSPORTE MOTORIZADO – DOMICILIARIO',
                'TRASPORTE CAMION O VEHICULO',
                'SERVICIO DE COMPRAS SIN TRANSPORTE',
                'SERVICIO DE COMPRAS CON TRANSPORTE',
