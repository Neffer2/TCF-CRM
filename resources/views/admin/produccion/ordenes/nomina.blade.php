...
@section('content')
    <div class="row">
                ...
                <div class="card-header p-0 mx-3 my-3 position-relative z-index-1 col-md-6">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p class="text-sm mb-0">Items consumidos en la orden de nómina. Presupuesto completo <a href="{{ route('presupuesto', $presupuesto->id_gestion) }}" target="_blank">aqu&iacute;.</a></p>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-12">
            @livewire('productor.ordenes.nomina', ['presupuesto' => $presupuesto, 'orden_nomina' => $orden])
        </div>
    </div>
@endsection
