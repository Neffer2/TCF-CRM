...
<head>
  ...
  <title>BULLCRM · Error inesperado</title>
...
<body>
  <main class="card">
    ...
    <span class="eyebrow">Error inesperado</span>
    <h1>Algo salió mal</h1>
    <p>Ocurrió un error al procesar la página. Ya quedó registrado; intenta de nuevo o avísale al administrador del CRM.</p>
