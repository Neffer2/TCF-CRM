        ...
        <tbody>
            ...
            @if ($tipo)
                <tr>
                    ...
                    <td class="text-center" colspan="2" style="text-align: center; background-color: #e4e4e4;">{{ $presto->imprevistos }} %</td>
                    <td colspan="2"></td>
                ...
                <tr>
                    ...
                    <td class="text-center" colspan="2" style="text-align: center; background-color: #e4e4e4;">{{ $presto->administracion }} %</td>
                    <td colspan="2"></td>
                ...
                <tr>
                    ...
                    <td class="text-center" colspan="2" style="text-align: center; background-color: #e4e4e4;">{{ $presto->fee }} %</td>
                    <td colspan="2"></td>
