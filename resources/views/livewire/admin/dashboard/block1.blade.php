    ...
    <article class="crm-kpi {{ $tonoMes }}" style="--i:0">
        <div class="crm-kpi__head">
            <div>
                ...
                <h3 class="crm-kpi__value"><small>$</small><span data-count="{{ round($venta_facturada) }}" data-key="venta_mes">{{ number_format($venta_facturada, 0, '.', ',') }}</span></h3>
            </div>
    ...
    <article class="crm-kpi tone-neutral" style="--i:1">
        <div class="crm-kpi__head">
            <div>
                ...
                <h3 class="crm-kpi__value"><small>$</small><span data-count="{{ round($presto_mensual) }}" data-key="presto_mes">{{ number_format($presto_mensual, 0, '.', ',') }}</span></h3>
            </div>
    ...
    <article class="crm-kpi {{ $tonoMes }}" style="--i:2">
        <div class="crm-kpi__head">
            <div>
                ...
                <h3 class="crm-kpi__value"><span data-count="{{ sprintf('%.1f', $cumpli_venta_men) }}" data-key="cumpli_mes" data-decimals="1">{{ sprintf('%.1f', $cumpli_venta_men) }}</span><small> %</small></h3>
            </div>
    ...
    <article class="crm-kpi {{ $tonoAcum }}" style="--i:3">
        <div class="crm-kpi__head">
            <div>
                ...
                <h3 class="crm-kpi__value"><small>$</small><span data-count="{{ round($venta_consolidada) }}" data-key="venta_acum">{{ number_format($venta_consolidada, 0, '.', ',') }}</span></h3>
            </div>
    ...
    <article class="crm-kpi tone-neutral" style="--i:4">
        <div class="crm-kpi__head">
            <div>
                ...
                <h3 class="crm-kpi__value"><small>$</small><span data-count="{{ round($presto_acumulado) }}" data-key="presto_acum">{{ number_format($presto_acumulado, 0, '.', ',') }}</span></h3>
            </div>
    ...
    <article class="crm-kpi {{ $tonoAcum }}" style="--i:5">
        <div class="crm-kpi__head">
            <div>
                ...
                <h3 class="crm-kpi__value"><span data-count="{{ sprintf('%.1f', $cumpli_acum_venta_men) }}" data-key="cumpli_acum" data-decimals="1">{{ sprintf('%.1f', $cumpli_acum_venta_men) }}</span><small> %</small></h3>
            </div>
    ...
    <article class="crm-kpi crm-kpi--wide tone-neutral" style="--i:6">
        <div class="crm-kpi__head">
            <div>
                ...
                <h3 class="crm-kpi__value"><span data-count="{{ sprintf('%.1f', $presto_x_cumplir) }}" data-key="por_cumplir" data-decimals="1">{{ sprintf('%.1f', $presto_x_cumplir) }}</span><small> %</small></h3>
            </div>
        ...
        <div class="crm-kpi__sub">
            ...
            <div class="crm-ring" data-ring="{{ $logrado }}" style="--pct: 0" role="img" aria-label="{{ sprintf('%.1f', $logrado) }} % logrado, {{ sprintf('%.1f', $porCumplir) }} % por cumplir">
                <span><b data-count="{{ sprintf('%.0f', $logrado) }}" data-key="logrado">{{ sprintf('%.0f', $logrado) }}</b>%</span>
            </div>
        </div>
        <div class="crm-kpi__foot">
