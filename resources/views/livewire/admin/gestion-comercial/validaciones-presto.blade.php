    ...
    <div class="card-header p-0 px-3 mt-3">
        <div class="row">
            <div class="col-md-12">
                ...
                <p class="text-sm mb-0">Presupuestos por validar..</p>
            </div>
                ...
                <tbody>
                    @foreach ($presupuestos as $presupuesto)
                        <tr>
                            ...
                            <td>
                                <p class="text-xs font-weight-bold mb-0">Fecha envío</p>
                                <p class="text-xs text-secondary mb-0">{{ $presupuesto->updated_at }}</p>
                            </td>
                            <td>
