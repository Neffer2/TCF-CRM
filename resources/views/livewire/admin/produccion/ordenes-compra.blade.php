@if (Auth::user()->rol == 1)
    <div>
        ...
        @elseif ($submódulo == 'vehiculos_bodega')
            ...
            @livewire('admin.produccion.ordenes_-compra.ordenes-compra-vehiculos-y-bodega')

        @elseif ($submódulo == 'nomina')
            <!-- VISTA DE NÓMINA -->
            @livewire('admin.produccion.ordenes_-compra.ordenes-compra-nomina')
        @endif
    </div>
