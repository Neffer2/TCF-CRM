            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input wire:model.lazy="cod_cc" id="cod_cc" type="number" name="cod_cc" class="form-control @error('cod_cc') is-invalid @elseif(strlen($cod_cc) > 0) is-valid @enderror" value="{{ old('cod_cc') }}" placeholder="COD C.C." required>
                        @error('cod_cc')
