                ...
                <tbody>
                    @foreach ($anticipos as $key => $anticipo)
                        <tr>
                            ...
                            <td class=""> 
                                <a class="btn bg-gradient-primary m-0 me-1 mb-1" href="{{ route('detalle-anticipo-contabilidad', ['anticipo_id' => $anticipo->id]) }}" target="_blank" title="Ver detalle del anticipo">
                                    Causar
                                </a> 
                            </td> 
                        </tr>
