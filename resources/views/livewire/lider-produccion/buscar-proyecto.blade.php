<div>
    <div class="card">
        <div class="card-header p-0 px-3 mt-3">
            <div class="row gy-1">            
                <div class="col-md-12"> 
                    <h3 class="mb-0">CENTROS DE COSTOS</h3>
                    <p class="text-sm mb-0">Lista completa de centros de costos.</p>
                </div> 
        ...
        <div class="card-body p-0 pt-1">
            <div class="table-responsive"> 
                <table class="table align-items-center mb-0">
                    <thead> 
                        <tr>
                            <th colspan="7" class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">DATOS DE PROYECTO</th>
                        </tr>
                    </thead> 
                    <tbody> 
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p class="text-xs text-secondary mb-0">
                                        @if ($presupuesto->productor_info)
                                            {{ $presupuesto->productor_info->name }}
                                        @endif
                                    </p>
                                </td>
                                <td>
